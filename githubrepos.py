        ...
        try:
            ...
            while next_page_url:
                ...
                if response.status_code == 403:
                    ...
                    if sleep_time > 0:
                        logging.warning(f"Rate limit hit. Sleeping for {sleep_time:.2f} seconds.")
                        time.sleep(sleep_time)
                        continue
                    else:
                        logging.error("Unexpected error: Rate limit exceeded without reset info.")
                        return {}
            ...
            time.sleep(60)  # In case of rate limit or other error, wait a minute before trying again
